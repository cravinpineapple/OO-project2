...
public class Level4 implements LevelActivator {
	...
	Timer timer = new Timer(100, new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			canvas.levelText = new TextDraw("Level 4", textX, textY, currentColor, textSize);
	...
	public Level4(GameBoard gameBoard) {
	...
	public void setLevelSettings() {
		EnemyComposite.UNIT_MOVE = 6;
		EnemyComposite.NCOLS = 8;
	}

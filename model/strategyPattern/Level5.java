...
public class Level5 implements LevelActivator {
	...
	Timer timer = new Timer(100, new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			canvas.levelText = new TextDraw("Level 5", textX, textY, currentColor, textSize);
	...
	public Level5(GameBoard gameBoard) {
